"""Вопросы с подвохом.
Викторина из несколыких вопросов с подвохом."""
...
QUESTIONS = [
 {'question': "How many times can you take 2 apples from a pile of 10 apples?",
  ...
  'accept': ['once', 'one', '1']},
 {'question': 'What begins with "e" and ends with "e" but only '
 ...
 {'question': "What does a towel get as it dries?",
  'answer': "Drier.",
  'accept': ['drier', 'dry']},
 {'question': "Imagine you are in a haunted house full of evil ghosts. "
  "What do you have to do to stay safe?",
  'answer': "Nothing. You're only imagining it.",
  'accept': ['nothing', 'stop']},
 {'question': "A taxi driver is going the wrong way down a one way street. "
  "She passes ten cops but doesn't get a ticket. Why not?",
 ...
 {'question': "If you're in the middle of a square house facing the west side "
  "with the south side to your left and the north side to your right, "
  "which side of the house are you next to?",
 ...
 {'question': "How much dirt is in a hole 3 meters wide, 3 meters long, "
  ...
  'accept': ['no', 'none', 'zero']},
 {'question': "A girl mails a letter from America to Japan. "
  "How many miles did the stamp move?",
  'answer': "Zero. The stamp was in the same place on the envelope "
  "the whole time.",
  'accept': ['zero', '0', 'none', 'no']},
 {'question': "What was the highest mountain on Earth the day before "
  "Mount Everest was discovered?",
  'answer': "Mount Everest was still the highest mountain of Earth "
 ...
 {'question': "How many fingers do most people have on their two hands?",
  ...
  'accept': ['eight', '8']},
 {'question': "The 4th of July is a holiday in America. "
 ...
 {'question': "Why is it illegal for a person living in North Dakota "
  "to be buried in South Dakota?",
 ...
 {'question': "How many heads does a two-headed coin have?",
  'answer': "Zero. Coins are just circular pieces of metal. "
 ...
 {'question': "Gwen's mother has five daughters. Four are named Haha, Hehe, "
  ...
  'answer': "Gwen.",
  'accept': ['gwen']},
 {'question': "How long is a fence if there are three fence posts "
  "each one meter apart?",
 ...
 {'question': "Where was the United States Declaration of "
  "Independence signed?",
  'answer': "It was signed at the bottom.",
  'accept': ['bottom']},
 {'question': "A person puts two walnuts in their pocket but only has "
  "one thing in their pocket five minutes later. What is it?",
  'answer': "A hole.",
  'accept': ['hole']},
 ...
 {'question': "If you drop a raw egg on a concrete floor, will it crack?",
  ...
  'accept': ['no']},
 {'question': "If it takes ten people ten hours to build a fence, how "
  "many hours does it take five people to build it?",
  'answer': "Zero. It's already built.",
  'accept': ['zero', 'no', '0', 'already', 'built']},
 {'question': "Which is heavier, 100 pounds of rocks or "
  "100 pounds of feathers?",
  'answer': "Neither. They weigh the same.",
  'accept': ['neither', 'none', 'no', 'same', 'even', 'balance']},
 {'question': "What do you have to do to survive being bitten by "
  "a poisonous snake?",
  'answer': "Nothing. Only venomous snakes are deadly.",
  'accept': ['nothing', 'anything']},
 {'question': "What three consecutive days don't include Sunday, "
  "Wednesday, or Friday?",
  'answer': "Yesterday, today, and tomorrow.",
  'accept': ['yesterday', 'today', 'tomorrow']},
 {'question': "If there are ten apples and you take away two, "
  "how many do you have?",
  'answer': "Two.",
  'accept': ['2', 'two']},
 {'question': "A 39 year old person was born on the 22nd of February. "
  "What year is their birthday?",
 ...
 {'question': "What do you get if you divide one hundred by half?",
  'answer': "One hundred divided by half is two hundred. One hundred "
  "divided by two is fifty.",
  'accept': ['two', '200']},
 {'question': "What do you call someone who always knows where "
  "their spouse is?",
 ...
 {'question': "An electric train leaves the windy city of Chicago at 4pm on a "
  "Monday heading south at 100 kilometers per hour. Which way does the smoke "
 ...
 {'question': "A doctor gives you three pills with instructions to take "
  "one every half-hour. How long will the pills last?",
  'answer': "One hour.",
  'accept': ['1', 'one']},
...
print('''Trick Questions.
         ...
         (Enter QUIT to quit at ane time.)''')
input('Press Enter to begin...')

random.shuffle(QUESTIONS)
score = 0

for question_number, qa in enumerate(QUESTIONS):
    print('\n' * 20)
