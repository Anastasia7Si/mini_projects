"""Переодическая таблица элементов.
...
with open('periodictable.csv', encoding='utf-8') as elements_file:
...
print('Periodiv Table of Elements.\n')
while True:
...
''')
    print('Enter a symbol or atomic number or examine, or QUIT to quit.')
